...
public class ProductControllerTest {
  ...
  void 상품조회() {
    ...
    ProductResponseDto responseDto = restClient.get().uri(url).retrieve()
  ...
  void 상품등록() {
    ...
    ProductResponseDto responseDto = restClient.post().uri(url)
  ...
  void 상품수정() {
    ...
    ProductResponseDto responseDto = restClient.patch().uri(url)
        .contentType(MediaType.APPLICATION_JSON) // JSON 타입 지정
        .body(requestDto).retrieve().body(ProductResponseDto.class);
