...
import gift.product.application.usecase.mapper.ProductMapper;
...
@UseCase
@Transactional
public class ProductInteractor implements AddProductUseCase, GetProductUseCase, GetAllProductsUseCase, UpdateProductUseCase, DeleteProductUseCase {
